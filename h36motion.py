...
class H36motion(Dataset):
    ...
    def __init__(self, path_to_data, actions, input_n=10, output_n=10, dct_n=20, split=0, sample_rate=2, data_mean=0,
        ...
        self.all_seqs = torch.from_numpy(self.all_seqs)
        self.input_dct_seq = torch.from_numpy(self.input_dct_seq)
        self.output_dct_seq = torch.from_numpy(self.output_dct_seq)
